...
func GetPatientInfoByName(db *sql.DB, card_id string) (*PatientInfo, error) {
...
func GetServiceInfoBycardID(db *sql.DB, card_id string) ([]PatientInfo, error) {
...
func FormatServiceInfo(activity []PatientInfo) string {
